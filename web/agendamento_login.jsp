...
<html>
    <head>
        ...
        <title>Taí Telecom - Agendamento</title>
    </head>
    <body>
        ...
        <div class="container text-center mt-5">
            <div class="row g-2"> <!-- Define o `gutter` como 2 (espaço reduzido entre colunas) -->
                <div class="col-md-5 offset-md-2"> <!-- Aumenta o alinhamento à esquerda -->
                    <a href="form_cadastrar_agenda.jsp" class="btn btn-transparent">
                        <img src="imagens/cadastrar_agendamento.png" alt="Cadastrar Produto"> <!-- Imagem para Cadastrar -->
