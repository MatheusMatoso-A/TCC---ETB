            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4"> <!-- Usando 4 colunas para telas grandes e 6 colunas para telas médias -->
                    <form action="alterar_produto.do" method="post">
                         ...
                         <div class="mb-3">
                            <!-- Nome do Produto -->
                            <label for="id" class="form-label">ID: ${param.id} </label>
                            <input type="hidden"  id="id" name="id" value="${param.id}" required>
                        </div>
                        
                        <div class="mb-3">
                            <!-- Nome do Produto -->
                            <label for="nome" class="form-label">Nome do Produto</label>
                            <input type="text" class="form-control" id="nome" name="nome" value="${param.nome}"  required>
                        </div>

                        <div class="mb-3">
                            <!-- Velocidade -->
                            <label for="velocidade" class="form-label">Velocidade</label>
                            <input type="text" class="form-control" id="velocidade" name="velocidade"  value="${param.velocidade}" required>
                        </div>

                        <div class="mb-3">
                            <!-- Valor -->
                            <label for="valor" class="form-label">Valor</label>
                            <input type="text" class="form-control" id="valor" name="valor" value="${param.valor}"  required>
                        </div>
